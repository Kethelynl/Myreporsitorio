...
function changeLanguage() {
  ...
  document.getElementById("projetos2").textContent = translations[selectedLang].projetos2;
  document.getElementById("home").textContent = translations[selectedLang].home;
  document.getElementById("home2").textContent = translations[selectedLang].home2;
  document.getElementById("tecnologias").textContent = translations[selectedLang].tecnologias;
  document.getElementById("tecnologias2").textContent = translations[selectedLang].tecnologias2;
  document.getElementById("servicos").textContent = translations[selectedLang].servicos;
  document.getElementById("servicos2").textContent = translations[selectedLang].servicos2;
  document.getElementById("blog").textContent = translations[selectedLang].blog;
  document.getElementById("blog2").textContent = translations[selectedLang].blog2;
